...
function ActivityCard() {
  ...
  const { activities, setActivities, showInterestedUsers, selectedActivity, interestedClick, visitedClick, handleViewClick, handleXClick, displayInterestedUsers } = useContext(ActivitiesContext)
